...
<head>
    ...
    <script type="text/javascript" charset="utf8"
            src="https://cdn.datatables.net/1.10.16/js/dataTables.bootstrap4.min.js" defer></script>
                                ...
                                @if (count(auth::user()->unreadNotifications) !== 0)
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        @foreach (auth::user()->unreadNotifications as $item)
                                            ...
                                            <a href=" {{ route('listaDemandas') }} " class="dropdown-item"
                                               value="{{ $item->data['message'] }}"> {{ $item->data['message'] }} </a>
                        ...
                        <li class="nav-item dropdown">
                            <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button"
                               data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                ...
                                @if(Auth::user()->image)
                                    <img src=" {{ asset('storage/' .Auth::user()->image) }} " title="Bootstrap"
                                         width="30" height="30">
                                @else
