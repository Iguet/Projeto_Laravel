                ...
                <div>
                    <div  class="form-group row" id="permissoes">
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" name="Vizualizar Projetos" value="" disabled>
                    ...
                    <div  class="form-group row" id="permissoes">
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" name="Vizualizar Demandas" value="" disabled>
                            <label class="form-check-label">Vizualizar</label>
                        </div>
                        <div class="form-check form-check-inline">
